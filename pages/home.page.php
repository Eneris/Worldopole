<header id="single-header">
	<div class="row">
		<div class="col-md-12 text-center">
			...
			<br>
			<h3><font style="color:rgb(210,118,118)">NEU!</font> Unsere <a href="/PoGoChemnitz.v1.0.1.apk">Android App</a><br><small style="color:rgb(210,118,118)">Hinweis: Die Live-Karte geht aktuell in der App nicht. Es wird demnächst ein Update geben. Solange einfach den Handy-Browser nutzen.</small></h3>
			<br>
